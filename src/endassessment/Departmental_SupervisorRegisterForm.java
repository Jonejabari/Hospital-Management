 ...
 * @author office
 */
public class Departmental_SupervisorRegisterForm extends javax.swing.JFrame {
    DBStatements DB = new DBStatements();
    DBConnection con = new DBConnection();
    regi rig = new regi();

    /**
     * Creates new form Departmental_Supervisor
     * @throws java.lang.Exception
     */
    public Departmental_SupervisorRegisterForm() {
        initComponents();
    }
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try
        {
            ...
            String sql = "insert into departmental_supervisors values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Departmental_SupervisorRegisterForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(Departmental_SupervisorRegisterForm.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
