 ...
 * @author office
 */
public class ministrialLogInForm extends javax.swing.JFrame {

    /**
     * Creates new form ministrialLogInForm
     */
    public ministrialLogInForm() {
        initComponents();
    }
    ...
    private void btnlogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlogActionPerformed
        ...
        try
        {
            ...
            ps = con.prepareStatement("SELECT * FROM `ministerial_supervisor` WHERE `Id Number` = ? and `Password` = ?");
            ...
            if(rs.next())
            {
                Ministrialmenu ms = new Ministrialmenu();
                ms.setVisible(true);
                ms.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ministrialLogInForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ministrialLogInForm().setVisible(true);
            }
        });
    }
